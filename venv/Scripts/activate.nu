...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\QA_learning\MyProjects_Python\TeamBook\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\QA_learning\MyProjects_Python\TeamBook\venv\Scripts\deactivate.nu'
